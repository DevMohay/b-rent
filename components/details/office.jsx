...
const OfficeDetails = ({ ad }) => {
    return (
        <div className="mt-4 space-y-6">
            <div className="bg-white rounded-xl shadow-md p-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800">Office Details</h2>
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="p-4 border rounded-lg bg-gray-50">
                        ...
                        <p className="text-lg font-medium text-gray-800">{ad.lift ? 'Yes' : 'No'}</p>
                    </div>
                    <div className="p-4 border rounded-lg bg-gray-50">
                        <p className="text-sm text-gray-500">AC</p>
                        <p className="text-lg font-medium text-gray-800">{ad.ac ? 'Yes' : 'No'}</p>
                    </div>
                    <div className="p-4 border rounded-lg bg-gray-50">
